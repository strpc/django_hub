...
from .tools import Path_and_rename
...
class Actor(models.Model):
    ...
    image = ResizedImageField('Изображение', upload_to=Path_and_rename('actors/', 'photo'))
...
class Movie(models.Model):
    ...
    poster = ResizedImageField('Постер', upload_to=Path_and_rename('movies/', 'poster'))
...
class MovieShots(models.Model):
    ...
    image = ResizedImageField('Изображение', upload_to=Path_and_rename('movie_shots/', 'shots'))
